...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setBounds(74, 340, 270, 40);
...
ImageIcon A= new ImageIcon(getClass().getResource("images/quitter1.png"));
   ...
   String password =jPasswordField1.getText();
            ...
            if(password.equals("ігор") && id.equals("Ігор") || password.equals("катерина") && id.equals("Катерина")|| password.equals("дмитро") && id.equals("Дмитро")){
                ...
                app.setVisible(true);
                     ...
                     ImageIcon F= new ImageIcon(getClass().getResource("images/men.png"));
                     app.jLabel9.setIcon(F);
                     this.dispose();
                 }
                   if( id.equals("Катерина")){
                     
                Application app=new Application();
                app.setVisible(true);
                     app.jLabel17.setText(id);
                     ImageIcon F= new ImageIcon(getClass().getResource("images/women.png"));
                     app.jLabel9.setIcon(F);
                     this.dispose();
                 }
                     if( id.equals("Дмитро")){
                ...
                JOptionPane.showMessageDialog(null,"неправильні дані для входу","неможливо увійти",JOptionPane.ERROR_MESSAGE);
                 jPasswordField1.setText(null);
                 jTextField1.setText(null);
            }
