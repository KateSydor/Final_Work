...
public class Application extends javax.swing.JFrame {
    ...
    private static ArrayList<String> txt =new ArrayList<>();
    private static  String txtWord;
    Client client;
    Server server;
    ...
    public void start(JInternalFrame fr){
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication/images/main.jpg"))); // NOI18N
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication/images/importKey1.png"))); // NOI18N
        ...
        jLabel20.setToolTipText("Заванажити ключ");
        ...
        jLabel21.setToolTipText("Зберегти ключ");
        ...
        jLabel24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication/images/send1.png"))); // NOI18N
        ...
        jLabel25.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication/images/run1.png"))); // NOI18N
        jLabel25.setToolTipText("Запуск сервера");
        ...
        jLabel26.setToolTipText("Приєднання користувача");
        ...
        jLabel7.setBounds(21, 290, 239, 76);
        ...
        jLabel5.setBounds(21, 390, 239, 76);

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication/images/home1.png"))); // NOI18N
        ...
        jLabel6.setBounds(21, 190, 239, 76);
        ...
        jLabel28.setForeground(new java.awt.Color(109, 46, 70));
        jLabel28.setText("Безпека даних у хмарних обчисленнях");
        getContentPane().add(jLabel28);
        jLabel28.setBounds(100, 20, 920, 40);
 ...
 ImageIcon A= new ImageIcon(getClass().getResource("images/qt1.png"));
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
     start(jInternalFrame3);
   
    }//GEN-LAST:event_jLabel5MouseClicked

    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
    
    start(jInternalFrame2);    }//GEN-LAST:event_jLabel7MouseClicked
 ...
 ImageIcon A= new ImageIcon(getClass().getResource("images/securite1.png"));
   ...
   start(jInternalFrame1);
    
     }//GEN-LAST:event_jLabel6MouseClicked

    private void jLabel6MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseEntered
   ImageIcon A= new ImageIcon(getClass().getResource("images/home2.png"));
    jLabel6.setIcon(A);    }//GEN-LAST:event_jLabel6MouseEntered

    private void jLabel6MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseExited
    ImageIcon A= new ImageIcon(getClass().getResource("images/home1.png"));
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
        ...
        FileNameExtensionFilter filetxt=new FileNameExtensionFilter("txt","txt");
	...
	window2.setDialogTitle("Вибрати файл");
	...
	File file2= window2.getSelectedFile();
        ...
        jLabel14.enable();
        ImageIcon D= new ImageIcon(getClass().getResource("images/importKey1.png"));
        jLabel14.setIcon(D);
	...
	BufferedReader buffer=new BufferedReader(reader); 
	 String line="";
       ...
       txt.add(line);
            ...
            jTextArea1.setText("");
         	 for(String second_line: txt) {
         jTextArea1.append(second_line);
         jTextArea1.append("\n");
                 }
         if(buffer!=null){
             buffer.close();
...
ImageIcon A= new ImageIcon(getClass().getResource("images/importer1.png"));
 ...
 if(!jTextArea1.getText().equals(""))  {
       ...
       fs.setDialogTitle("Вибрати файл");
       FileNameExtensionFilter filetxt=new FileNameExtensionFilter("txt","txt");
        FileNameExtensionFilter filedoc=new FileNameExtensionFilter("word","docx");
...
ImageIcon A= new ImageIcon(getClass().getResource("images/exporter1.png"));
    ...
    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseClicked
        ...
        else{ key =jTextField1.getText();
//Дешифрувати word файл
       if(ext.contains(".docx")) {
          
                 String txtEncrypted = AES.encrypt(txtWord, key) ;
                 
		 String txtDecrypted1 = AES.decrypt(txtEncrypted, key) ;
                 txtWord = new String(txtDecrypted1.getBytes(),Charset.forName("UTF-8"));
                 
                  String txtDecrypted2 = AES.decrypt(txtWord, key) ;
                 txtWord = new String(txtDecrypted2.getBytes(),Charset.forName("UTF-8"));

         jTextArea1.setText("");
         jTextArea1.append(txtWord);
          jLabel11.enable();
         ImageIcon A= new ImageIcon(getClass().getResource("images/exporter1.png"));
         jLabel11.setIcon(A); 
...
//Дешифрувати текстовий файл

 if(ext.contains(".txt")) {
     	 for(int i = 0; i< txt.size(); i++) {
		 String encryptedString = AES.encrypt(txt.get(i), key) ;
		 txt.set(i, encryptedString);
	 }
     
 for(int i = 0; i< txt.size(); i++) {
		 String decryptedString = AES.decrypt(txt.get(i), key) ;
               String decryptedString2 = new String(decryptedString.getBytes(),Charset.forName("UTF-8"));

		 txt.set(i, decryptedString2);
	 }
 for(int i = 0; i< txt.size(); i++) {
		 String decryptedString = AES.decrypt(txt.get(i), key) ;
               String decryptedString2 = new String(decryptedString.getBytes(),Charset.forName("UTF-8"));
...
ImageIcon A= new ImageIcon(getClass().getResource("images/crypter1.png"));
    ...
    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        ...
        String fileKey="";
	window1.setDialogTitle("Завантажити ключ");
        FileNameExtensionFilter fileTxt=new FileNameExtensionFilter("текст","txt");
...
ImageIcon A= new ImageIcon(getClass().getResource("images/importKey2.png"));
    jLabel14.setIcon(A);      }//GEN-LAST:event_jLabel14MouseEntered

    private void jLabel14MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseExited
ImageIcon A= new ImageIcon(getClass().getResource("images/importKey1.png"));
...
ImageIcon A= new ImageIcon(getClass().getResource("images/send2.png"));
    jLabel24.setIcon(A);     }//GEN-LAST:event_jLabel24MouseEntered

    private void jLabel24MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel24MouseExited
    ImageIcon A= new ImageIcon(getClass().getResource("images/send1.png"));
    jLabel24.setIcon(A);
...
ImageIcon A= new ImageIcon(getClass().getResource("images/run2.png"));
    jLabel25.setIcon(A);     }//GEN-LAST:event_jLabel25MouseEntered

    private void jLabel25MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel25MouseExited
ImageIcon A= new ImageIcon(getClass().getResource("images/run1.png"));
...
//шифруємо текстовий файл
    ...
    private void jLabel22MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel22MouseClicked
     if(!jTextField2.getText().equals("" )){
      ...
      testKey2 = rsa.encryptRSA(text.getBytes());
    
        jTextField2.setText(Base64.getEncoder().encodeToString(testKey2));
 ...
 /*  if(jTextField2.getText()!=null){
     ...
     byte[] txtKey3 = rsa.decryptRSA(Base64.getMimeDecoder().decode(text));
 
       jTextField2.setText(new String(txtKey3) );
     }    else */
   ...
   //      System.out.println(split[split.length-1]);
         byte[] txtKey4 = rsa.decryptRSA(Base64.getMimeDecoder().decode(text));
    
       jTextField2.setText( new String(txtKey4) );
  ...
  if(!jTextField2.getText().equals(""))  {
        JFileChooser fs=new JFileChooser();
       fs.setDialogTitle("Зберегти ключ\n");
            int result=fs.showSaveDialog(null);
            if(result== JFileChooser.APPROVE_OPTION){
                String Container=jTextField2.getText();
                File file=fs.getSelectedFile();
